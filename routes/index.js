...
exports.index = function(req, res){
	...
	// direct way
	client.get("http://nieletdmello.cfapps.io/gumballs.json", function(data, response){
	...
	if(event==='TurnTheCrank' && state==='HasACoin'){
		...
		client.get("http://nieletdmello.cfapps.io/gumballs.json", function(data, response){
            ...
            if(count!==0){
            	...
            	client.put("http://nieletdmello.cfapps.io/gumballs/1", args, function(data,response) {
            	      // parsed response body as js object
            	    console.log(data);
            	    // raw response
            	    console.log(response);
